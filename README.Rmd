...
install.packages(c("tidyverse","ggthemes","knitr","caret","corrplot","VGAM"))
library(tidyverse)
library(ggthemes)
library(knitr)
library(caret)
...
phases %>% 
  ...
  geom_histogram(position = "stack", binwidth = 4) + 
  scale_x_sqrt() +
